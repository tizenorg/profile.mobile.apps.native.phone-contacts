...
#ifndef CONTACTS_MODEL_LIST_SEARCH_PROVIDER_H
#define CONTACTS_MODEL_LIST_SEARCH_PROVIDER_H
	...
	namespace List
	{
		namespace Model
		{
			...
			private:
				...
				void onInserted(Contacts::Model::ContactData &contactData, ContactDataProvider *provider);
...
#endif /* CONTACTS_MODEL_LIST_SEARCH_PROVIDER_H */
