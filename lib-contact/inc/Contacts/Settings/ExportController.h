...
namespace Contacts
{
	namespace Settings
	{
		 ...
		 */
		class EXPORT_API ExportController : public Ui::ProgressController
		{
		public:
			/**
			...
			ExportController(Evas_Object *parent, const char *title,
					std::vector<int> personIdList, Common::TargetStorage vcardStorage);

		private:
			void createDirectory();
			void getVcardFilePath();
		...
		private:
			...
			Common::TargetStorage m_VcardStorage;
		};
	}
}
