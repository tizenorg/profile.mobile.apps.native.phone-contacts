...
namespace Contacts
{
	namespace List
	{
		namespace Model
		{
			...
			protected:
				/**
				 * @brief Init contact record
				 * @param[in]   id  Contact ID
				 */
				void initContactRecord(int id);

				/**
				 * @brief Destroy and nullify contact record
				 */
				 ...
				 */
				static const char *getValue(contacts_record_h record, Contacts::ContactData::Field field);
			private:
