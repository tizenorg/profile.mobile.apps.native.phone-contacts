...
namespace
{
	...
	contacts_filter_h prepareModeTypeFilter(PersonProvider::ModeType modeType)
	{
		contacts_filter_h filter = nullptr;

		if (modeType != PersonProvider::ModeNone) {
	...
	contacts_filter_h getProviderFilter(PersonProvider::ModeType modeType, PersonProvider::FilterType filterType)
	{
	...
	contacts_list_h getPersonList(PersonProvider::ModeType modeType, PersonProvider::FilterType filterType)
	{
	...
	contacts_record_h getPersonRecord(int contactId, PersonProvider::ModeType modeType, PersonProvider::FilterType filterType)
	{
		contacts_query_h query = nullptr;
		contacts_query_create(_contacts_person._uri, &query);
...
PersonProvider::PersonProvider(ModeType modeType, FilterType filterType)
