...
ContactField &ContactFieldSubItem::getSubField() const
{
	return m_Field;
}
...
Evas_Object *ContactFieldSubItem::getContent(Evas_Object *parent, const char *part)
{
	if (strcmp(part, PART_MIDDLE) == 0) {
		return createSubFieldControl(parent)->getEvasObject();
	}
...
Ui::Control *ContactFieldSubItem::createSubFieldControl(Evas_Object *parent)
{
