...
Evas_Object *SortByPopup::createGenlist(Evas_Object *parent) {
	...
	elm_radio_state_value_set(m_RadioGroup, 0);
...
void SortByPopup::onSelect(void *data, Evas_Object *obj, void *event_info) {
	int type = (int) elm_object_item_data_get((Elm_Genlist_Item *) event_info);
	...
	elm_genlist_item_update((Elm_Genlist_Item *) event_info);
}
