		...
		app_control_result_e result)
{
	...
	exporter->setFinishCallback(std::bind(&ExportItem::onExportFinish, this, std::placeholders::_1));
	exporter->run();
}

void ExportItem::onExportFinish(const ProgressController &controller)
{
