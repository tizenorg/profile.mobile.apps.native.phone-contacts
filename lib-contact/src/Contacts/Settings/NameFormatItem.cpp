...
void NameFormatItem::onSelected()
{
	...
	popup->addItem(_("IDS_PB_OPT_FIRST_NAME_FIRST_ABB"), CONTACTS_NAME_DISPLAY_ORDER_FIRSTLAST);
	popup->addItem(_("IDS_PB_OPT_LAST_NAME_FIRST_ABB"), CONTACTS_NAME_DISPLAY_ORDER_LASTFIRST);
}
