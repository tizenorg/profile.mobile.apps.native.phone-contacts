...
namespace
{
	const struct
	{
		...
		{ GROUP_THUMBNAIL_SMALL, GROUP_THUMBNAIL_DEFAULT_SMALL, THUMBNAIL_SMALL_SIZE },
		{ GROUP_THUMBNAIL_MEDIUM, GROUP_THUMBNAIL_DEFAULT_MEDIUM, THUMBNAIL_MEDIUM_SIZE },
		{ GROUP_THUMBNAIL_LARGE, GROUP_THUMBNAIL_DEFAULT_LARGE, THUMBNAIL_LARGE_SIZE },
	};
...
Evas_Object *Thumbnail::onCreate(Evas_Object *parent)
{
	...
	int size = ELM_SCALE_SIZE(params[m_Size].size);
