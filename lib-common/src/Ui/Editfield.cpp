...
void Editfield::onChanged(Evas_Object *layout, Evas_Object *entry)
{
...
void Editfield::onFocused(Evas_Object *layout)
{
	elm_object_signal_emit(layout, "elm,state,focused", "");
}

void Editfield::onUnfocused(Evas_Object *layout)
{
	elm_object_signal_emit(layout, "elm,state,unfocused", "");
}

void Editfield::onClearPressed(Evas_Object *entry)
{
