...
namespace Contacts
{
	...
	public:
		...
		enum ContactDataType
		{
			...
			TypeLog,            /**< Log number */
			TypeContactName,    /**< Contact compared by name */
			TypeContactNumber,  /**< Contact compared by number */
			TypePerson,         /**< Person */
			TypeSearchItem      /**< Found ContactData */
		};
		 ...
		 */
		virtual ContactDataType getType() const = 0;
