...
namespace Contacts
{
	namespace Model
	{
		...
		private:
			/**
			 * @brief Reassign changed callback
			 * @remark Override this method only when you need to reassign
			 *      changed callback on ContactData update
			 * @param[in]   it  ContactData iterator
			 */
