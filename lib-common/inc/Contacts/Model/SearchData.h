...
namespace Contacts
{
	namespace Model
	{
		...
		public:
			...
			/**
			 * @see ContactData::setUpdateCallback()
			 */
			virtual void setUpdateCallback(UpdateCallback callback) override;

			/**
			 * @see ContactData::unsetUpdateCallback()
			 */
			virtual void unsetUpdateCallback() override;

			/**
			 * @see ContactdData::setDeleteCallback()
			 */
			virtual void setDeleteCallback(DeleteCallback callback) override;

			/**
			 * @see ContactData::unsetDeleteCallback()
			 */
			virtual void unsetDeleteCallback() override;

		protected:
			/**
			 * @see ContactData::onUpdated()
			 */
			virtual void onUpdated(int changes) override;

			/**
			 * @see ContactData::onDeleted()
			 */
