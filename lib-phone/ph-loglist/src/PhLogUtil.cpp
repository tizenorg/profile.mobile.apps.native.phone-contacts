...
{
	if (type == CONTACTS_PLOG_TYPE_VOICE_INCOMING
			|| type == CONTACTS_PLOG_TYPE_VIDEO_INCOMING)
		return TRUE;
	else
		return FALSE;
}
...
{
	if (type == CONTACTS_PLOG_TYPE_MMS_INCOMING
			|| type == CONTACTS_PLOG_TYPE_SMS_INCOMING
