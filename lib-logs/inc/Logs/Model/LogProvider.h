...
namespace Logs
{
	namespace Model
	{
		...
		private:
			void fillList(LogGroupList &logList);
			bool shouldGroupLogs(LogPtr log, LogGroupPtr prevLogGroup);

			void addLogGroup(LogGroupList &logList, contacts_record_h record);
			LogGroupPtr getFirstLogGroup(contacts_list_h list);
